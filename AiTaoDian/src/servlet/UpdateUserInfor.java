...
public class UpdateUserInfor extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		String name = new String(nameString.getBytes("ISO-8859-1"),"utf-8");//还原字节序列使用utf-8重新编码
		String major = new String(majorString.getBytes("ISO-8859-1"),"utf-8");//还原字节序列使用utf-8重新编码
		String address = new String(majorString.getBytes("ISO-8859-1"),"utf-8");
