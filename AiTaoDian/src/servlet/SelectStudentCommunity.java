...
public class SelectStudentCommunity extends HttpServlet {
	@Override
		...
		response.setCharacterEncoding("GBK");
		 ...
		 Connection connection=Dbutil.getConnection();
			try { Statement statement=connection.createStatement();
				String sql="select message.mes_id,god.username,message.title,message.content,tu1,tu2,tu3,message.time from message JOIN god ON message.user_id=god.phone where message.spec=3 and message.task=0";//
